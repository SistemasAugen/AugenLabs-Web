...
import useStyles from './TrivexParasol.styles';
import useGlobalStyles from "@styles/globals";
import trivex_parasol_glass from "@images/Trivex_Parasol_Vidrio.png";
import trivex_parasol_logo from "@images/Trivex_Parasol_Logo.png";

const Trivex_Parasol = () => {
        ...
        <Grid item md={6} xs={12} sm={6} className={[classes.first_section_left_container].join(" ")}>
          <Box className={classes.image_container}>
            <div className={classes.image_logo}>
              <Image
                data-aos="fade-in"
                src={trivex_parasol_logo}
                alt="parasol logo home"
              />
            </div>
            <Image
              data-aos="fade-in"
              src={trivex_parasol_glass}
...
Trivex_Parasol.propTypes = {}

export default Trivex_Parasol;