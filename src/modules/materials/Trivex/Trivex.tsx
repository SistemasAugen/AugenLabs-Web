...
import useStyles from './Trivex.styles';
import useGlobalStyles from "@styles/globals";
import trivex_glass from "@images/Trivex_Vidrio.png";
import trivex_logo from "@images/Trivex_Logo.png";
          ...
          <Box className={classes.image_container}>
            <div className={classes.image_logo}>
              <Image
                data-aos="fade-in"
                src={trivex_logo}
                alt="trivex logo home"
              />
            </div>
            <Image
              data-aos="fade-in"
              src={trivex_glass}
              alt="trivex background home"
            />
          </Box>
        </Grid>
